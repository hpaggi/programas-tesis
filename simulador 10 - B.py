...
def PROCESO_ARCH():
  ...
  global t_entrada, tipo_mens, t_generac, largo_cola,Q,Qx,niveles,S,T  , pendientes, restantes,cuenta_to, cuenta_e, cuenta_a, TABLA_TO
  TIMEOUTS=0
#  cuenta_to=0
  cuenta_e=0
  cuenta_a=0
