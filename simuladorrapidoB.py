...
def BUSCOPADRES(Y, m, id_campo, lista): # Busca en  la cola de entrada de Y un mens de C con ese id msg y id campo y en lista da la lista de padres (de ag que consultaron)
     ...
     for ag in range (1,N_agentes):
          if ((t,ag,Y,m,id_campo) in   tipo_mens) and tipo_mens[a,ag,Y,m,id_campo]=="1":
               lista.append(ag)
     ...
     #    print("proceso mensajes de OMEGA en main()") 
          ...
          #   print ("encontre", u,1,m,decision,tiempo )
               ...
               #   print("Q es ", Qx[u,1,m,decision]," calidad de OMEGA=",Qx1)
                         ...
                         if hora_inicial[iteracion, m1,decision1]+ TIMEOUT + TIMEOUT < t_entrada[u,1,m1,decision1, t_generac[u,1,m1,decision1,tiempo1]] and m1==m and decision1==decision and tiempo1>tiempo:
...
#  import pandas
     ...
     #import py_compile
     aq=1
     #Qwww=py_compile.compile("C:/Users/hpaggi/Dropbox/docs tesis/prototipo/cuarto negocio/simulador rapido 1207.py", cfile="C:/Users/hpaggi/Dropbox/docs tesis/prototipo/cuarto negocio/rapidito")
     #print(Qwww)
     aq=2    
     ...
     #  for MAXMENS in [100]: 
          ...
          # for MODO in ["S"]:
                    ...
                    # respuestas=numpy.zeros((N_agentes,N_agentes, MAXREGS,N_campos, maxt), dtype=int) tiene sentido que respuestas dependan de t?? +++
                         ...
                         formado_por = numpy.loadtxt(open("C:/Users/horacio/Dropbox/docs tesis/prototipo/cuarto negocio/dependencias.csv", "rb"), delimiter=",", skiprows=0)
