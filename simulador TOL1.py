          ...
          #       print("---- Calidad de OMEGA ="+str(Qx1))
            if t_generac[p, 1, r, decision,t+taux] + TIMEOUT > t_entrada [p,1,r,decision,t]:
              ...
              #          print ("calidad Y"+str(Qy)+"calidad X "+str(Qx[1, p, r,decision]))       
                ...
                if abs(Q[p,1, r,decision] - Qx1)<0.0001:
                  ES_EXITO_A=1
              #       EXITOS_A =EXITOS_A+1
...
#  import pandas
  ...
  for N_agentes in (30, 50):
    ...
    # los errores  y los topes de confianza
      ...
      # for MAXMENS in [1000]:
      for MAXMENS in (100, 200, 500, 1000):   
    #  for MAXMENS in [100]: 
        for MODO in ("S","I"):
       # for MODO in ["S"]:
          ...
          #       TABLA_TO[iteracion,N_agentes,MAXREGS,MAXMENS]=cuenta_to
              ...
              s="RESULTADOS_"+str(N_agentes)+"_"+str(MAXMENS)+"_"+MODO+"_"+str(MAXIT)+"_"+str(MAXREGS)+"_"+str(N_favoritos)+"TOL"+".txt"
