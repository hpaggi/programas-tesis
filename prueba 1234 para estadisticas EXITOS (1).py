...
def analizador (archivo, sal, TOTSIMPLE, TOTINTELIG, NROSAG, TOTSIMPLEAG, TOTINTELIGAG, TOTSIMPLEMENS, TOTINTELIGMENS,NROSMENS,ESTRICTOS_I,ESTRICTOS_S,T_I,T_S,nroarchivo):
    import datetime
...
def main():
    ...
    #
    #*************************************************
    # El archivo de salida es  RESULTADOS exitos xxxxx
    #
    sal="RESULTADOS EXITOS  "+ s1
    R=open(sal,'w')
    R.close    
    ...
    NROSMENS=[5,10,15,20,30,1000,0,0,0,0,0]
    ...
    while not EOF==1:
     ...
     #   print(line111)
        ...
        analizador(arch,sal, TOTSIMPLE, TOTINTELIG, NROSAG, TOTSIMPLEAG, TOTINTELIGAG,TOTSIMPLEMENS, TOTINTELIGMENS, NROSMENS,ESTRICTOS_I,ESTRICTOS_S,T_I,T_S,nroarchivo)
