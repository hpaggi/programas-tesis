...
def analizador (sal, archivo, T_O_SIMPLE, T_O_INTELIG,T_O_SIMPLE_MENS, T_O_INTELIG_MENS, T_O_S, T_O_I, T_O_S_MENS, T_O_I_MENS ,NROSAG, NROSMENS, ERRORES):
    import numpy
    import io
    # -*- coding: Windows-1252 -*-
    import codecs
...
def main():
    ...
    while not EOF==1:
     ...
     #   print(line111)
        ...
        analizador(s,arch, T_O_SIMPLE, T_O_INTELIG,T_O_SIMPLE_MENS, T_O_INTELIG_MENS,T_O_S, T_O_I,T_O_S_MENS, T_O_I_MENS, NROSAG, NROSMENS, ERRORES)
