       ...
       #     print("no es T O y es repuesta de",xx," a", ag)
          ...
          #    print("no es T O y es consulta de",xx," a", ag)   
              ...
              if t_generac[xx, ag, m, campo,a] + TIMEOUT < a:
                TO_MSG[xx,ag]=TO_MSG[xx,ag]+1   # TO_MSG cuenta cuantos time outs hubo entre dos agentes
...
#  import pandas
  ...
  global MAXREGS
  MAXREGS= 32       # 40 es el numero real  
    ...
    #  for MAXMENS in [100]: 
       ...
       # for MODO in ["S"]:
          ...
          #       TABLA_TO[iteracion,N_agentes,MAXREGS,MAXMENS]=cuenta_to
              ...
              s="RESULTADOS_"+str(N_agentes)+"_"+str(MAXMENS)+"_"+MODO+"_"+str(MAXIT)+"_"+str(MAXREGS)+".txt"
